...
<script charset="gb2312"  type="text/javascript">
	...
	function addSku(skuId){
		//市场价格
		var m = $("#m"+skuId).attr("disable",true).val();
		//售价
		var p = $("#p"+skuId).attr("disable",true).val();
		//库存
		var s = $("#s"+skuId).attr("disable",true).val();
		//限制
		var l = $("#l"+skuId).attr("disable",true).val();
		//费用
		var f = $("#f"+skuId).attr("disable",true).val();	
		...
		//库存
		$("#s"+skuId).attr("disabled","disabled");
		//限制
